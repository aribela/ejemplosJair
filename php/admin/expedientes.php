...
list($result,$selected_keys) = $casosObj->ObtListadoCasosGrid($idCliente, $idAbogado, $mostrarCamposTitular, $filTexto, $filEstatus, $titularId, $filtroTitular,$pantalla=0, $activar, $responsables, $clientes, $estatus, $juicios, $juzgados, $materias, $camposIds, $mostrarCamposGrid);
